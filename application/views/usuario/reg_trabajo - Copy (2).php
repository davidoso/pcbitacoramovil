                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control rounded-0" name="fecha_termino" id="fecha_termino" placeholder="Fecha" onfocusout="validar_fecha()" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="time" class="form-control rounded-0" name="hora_termino" id="hora_termino" placeholder="" onfocusout="validar_tiempo()" required>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                ...
                function validar_tiempo()
                {
                    ...
                    if (fecha_termino==fecha_inicio)
                    {
                        ...
                        {
                            alert("La hora de termino debe ser mayor o igual a la de inicio");
